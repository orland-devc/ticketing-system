        ...
        <div class="bg-gray-800 h-screen w-72 border-r border-gray-500">
            <div id="side-bar" class="flex flex-col mt-4">
                ...
                <div class="shrink-0 flex items-center mx-3 px-2 pb-4 border-b-2 border-gray-500 mr-3">
                    ...
                    <span class="text-xl font-semibold tracking-wide text-white">Admin Panel</span>
                ...
                <nav class="flex-grow space-y-2 p-3">
                    ...
                    <x-nav-link :href="route('admindashboard')" :active="$currentRoute === 'messages'">
                        <i class="fas fa-envelope my-auto mr-5"></i>
                        <span>{{ __('Messages') }}</span>
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('manage.users')" :active="$currentRoute === 'manage.users'">
                        <i class="fas fa-users-cog my-auto mr-5"></i>
                        <span>{{ __('User Management') }}</span>
                    </x-nav-link>
                </nav>
            ...
            <nav id="botNav" class="mt-1 space-y-2 ml-0 border-t-2 border-gray-500 absolute bottom-5 botNav p-1" style="">
