...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="max-h-screen">
            ...
            <!-- Page Heading -->
            @if (isset($header))
                <header id="header" class="shadow pl-72 bg-white">
                    <div id="header1" class="mx-auto pt-2 pb-4 px-6 flex items-center justify-between">
                        {{ $header }}    
                    </div>
                </div>
                </header>
            ...
            <!-- Page Content -->
            <main id="mainContent" class="mt-0 pl-72">
                {{ $slot }}
            </main>
        </div>
    </body>
